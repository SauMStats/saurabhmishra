      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <section className="mb-12">
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            assisting with grading and evaluation, and supporting students in building
            strong conceptual and computational foundations.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="text-gray-600 dark:text-gray-300 list-disc list-inside space-y-2">
            ...
            <li>Provided academic support to students in mathematics and statistics</li>
            <li>Assisted instructors with course logistics and assessment activities</li>
          </ul>
        </section>
